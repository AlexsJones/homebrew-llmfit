class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "8d6f33a9ff48cbcfe7ecbd26b0f2d6d5b46edccdc16fa140fe3087829728ab70"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "864362e4279de367334d5bcf01c4aef2d6df2f1e5d20c6908b171e456045e31a"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "2c64fcfb4bd29e4bcbe283c952f892592016e63f28cd7f3f10965e7d2f5ec671"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "bfa90f7940779c6dfe47cca2324fa24eb2ae26e435f430903642eec0ac6dd4d6"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "49d60352cdfd76692bf86671f63d2f456d79df541a0c069baed704a7781211c0"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "86f57644d66b1dcf859b529fd27b38ade452fcba9345f3dbcaecb31147683edc"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "82f4c8c92ab85e29ef2f451f67fc42c5cb8ec440c2abcd7d7f0999970f51f264"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "261ad96220ff4125f153362487af12621d0615cb16f10076f761bb2fd2c74f83"
    end
  end

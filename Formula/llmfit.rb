class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "c9afc65777e6228ec7def96e4b994890edbe3df5cd4b00d4bf1e2c3bf54154e7"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "257f7fac2235728f26c332cafeb81f89d8fc924c3b7df9cae5c981fadc0bf2ed"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "1166f9beeeaf118e67e78a1c70655d76738bf0dffa27284520f8fb9e418f431c"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "09cd16b08467f5ad12def76ca432eef8d4c880cfda2bb78a0b79e6546e412792"
    end
  end

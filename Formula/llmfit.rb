class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "3f3b25778e8e824762f6179e910b7c8b558ed238c976c933f6fda43102a2780a"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "c2602b55645b6940897cec6b679997141c6eb4d3141bc6ac99690bae873b0b50"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "6c6f52246cd204819fcb843b94fae202e78a89897f639bd2c2a2554b50d2834d"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "a68a3eed10cf6c921a72180e426cd29894a562a5c23260ddfcc55fb747cd76fa"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "3f1d309e534de478c6615d5e7202c59203300d7655e6951cee288f2ad599ed53"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "4917f5ca40ae8090dd8f645072350a9294dd6cd3e63b26594726c282e5835fe3"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "c6961159944f550a4ee492bfab078dac16fd065db16a2862804a1e4686f549c5"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "723112880622d11c37508a56ee1a452560de13c60a2913fa38483948d65fdfdf"
    end
  end

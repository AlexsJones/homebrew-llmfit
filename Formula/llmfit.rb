class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "2ba9bcf36c503086c610ef14e5f816817b7dba4383e16f80c4c1cc15435659b0"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "00bcbf038e9c06be38b55ff77892ca6bba76845d4558f2c971d3b80aaa1e3bf3"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "b539f6693aa20dc064c03add77dcc2e77fb3ef5158eda1aef9fe70451329860d"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "77b3d07083dcb840dbdaa9746eb06be50be4fbb324c1b0707f65313d62c98ce9"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "b6999eab6c20800feb58ad3bc118c14c394b7c274ec951c59f78774f1f673a23"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "b66b19108102c155bf5c56a3574f63b0a3e1514e1d1429f56bdf32d51de5c7fa"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "206f8c47f6c923f9bbbee47852517826cd881f7c96bbf75bcdd8c58085157b21"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "b34d005d9c631b4d9e045cbf814a3c5fe77d0c3c9ee3491b412cd1e77574d12a"
    end
  end

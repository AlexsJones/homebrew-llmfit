class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "7d5906a63372c6e422adc2059d56a3de399fec4748837df9f7ee515f0e864c79"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "8299c23f3a1a707301e8a158383e330b77ee7b7b0d7ec3f0499f03a4c6b224ca"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "95efc5bb5d639b2fe2ac5b7c5447e6928d9b65d2f51df3e88a798b699d448411"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "44786281eb73ca6d5e83f27eeffdc0b841a2123088653566e5361bc5b9f9f33c"
    end
  end

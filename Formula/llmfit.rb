class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "be54c9e188bb84ed4703c1733c0661a90ee1ebbee83136780b6a41761d2779ae"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "38f292e8f7b6409d204caf7546f20b067d061a2b64aebd445a6157a72b16ce8e"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "89a1c6896da3cd1d29136c33aead2c256f33dc6431c2661cfcd4eb7b2e9c3e7d"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "72e582e0ab94ba0684654fc3d6b830bf40f59dbcd9704b0b157dd633799f59cf"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "43f489c5f702c23d005f67a0186ca413de844d1ef386e022a026a63b4595360d"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "d08d8aa5d49fecb1870f1e9a59f8e8387a898703a36a6f858c7e56eb8220dd3c"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "b07260fefa18ec2388716725b11bc52255095d97bdf0420a22647e3130cfff3b"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "c493b53add720026a32a16992a7beb1f233a4cdec2e8651ae18418153fa4938b"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "5918b1051fe97a669456829cebf4cf207b235fa2b366dff6b16f390f84893901"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "54994fbd39701d090a08b4bff29ebbf7c0a5616d85d58109116c427e7ba68c3e"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "6f54070928dd143dd9ff6df605d8c1cae92b4c4fd207f07a1828793d86586d17"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "df7a1ae8a764d4cf935f93554a8c820fbfcada4c4522ddcafdf43f4340ada4d6"
    end
  end

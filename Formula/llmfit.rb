class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "71c5629b52d63d837df69412c0f64576f0c44e65ea8e9dcd18fc0bcbd95eb0c0"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "2759933fc012ca2a4f2c3500c34da155d9af5728b5828abe161c5b3f97b780b4"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "6857094a3346d08bfc81a8497827b2ad3085e647a85158028d2c7b38f3f063de"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "201ac34659d5748f78ba6120db5c1695aa3f053a01c50b1e3b20b3904af5cff0"
    end
  end

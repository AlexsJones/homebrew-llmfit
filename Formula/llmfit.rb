class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "c99ac21bd652ce70439541a97646782de1b2a84f1dccb4f4658db72cb7738a6f"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "ad0b10d4b1a4128f6461c0bc528c3ca56b7c7a03e799b15b21b22487dafbdc26"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "1c0d3173016c5901754cf73034edfaf103d5f5089dde53825acbb3766d16de88"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "d01f2b8db5be029e7896b6e44a6e22195576f943af3cb9443d4aa137cfc0b838"
    end
  end

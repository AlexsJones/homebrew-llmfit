class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "34370821289ed0d46e20c0caea38dd13ad7e283d553c3645bf84a19dd996925f"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "a2079e86de24df57ba0dbb0b1f6681fa5eb70d08464dcf3ef0e40ade4f1a938d"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "9a448cbd5aad964d267c4a49a7f17a52443d15bdb8dd161747f43a99d38b326e"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "8eafd2d5b73453bd03a594cf307253263a8b317da07b1dac3014fc98046b5c0e"
    end
  end

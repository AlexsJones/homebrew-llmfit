class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "cc23be0daf40df141b21a8c6ad63d32b5cefeef8675d45bafccac8548d5a022d"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "2024683f0ec5e2c005a39e16bafe3dc94ac173e75aedecee6964b0014fd265a0"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "22bec20325d04c319754b890b9ef7a79f9ace8c746064334fdd67b4bac90664b"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "502c7dd9a002f88483ada212a2435b9e335b7c21795f6b5bbd6ef07ae56b6e84"
    end
  end

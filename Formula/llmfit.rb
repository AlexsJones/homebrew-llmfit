class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "2a9a75a556cc74b8e70d609bed703f49237cf4db240e4940782998ea868cab0b"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "411cabf2d1c7d0da60bbcfd5d046944fd7e70b23b411a918b9796a98fd7ea5e6"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "53efd04e4190d95cf0bcd4b2a0fdfaff2c2ae05916d22e34f84159d6cbe9abbe"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "3711f563c4c57ebed3e98773b2da5d46a079936498df1f242b9012a6523dceb6"
    end
  end

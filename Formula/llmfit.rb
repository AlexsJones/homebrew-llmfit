class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "e84c2241bf2fc30d41f35e2b0026f10e2b35c4f56abab1a470e1ef9690eef3c4"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "5e77142eae165e714b9c12ac6a3566aa723ae6848fa21a16a72f80c05a6f20b2"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "7a9fcec56af6774901dfac4122587527614e33c3ff8be3c6ef3b325661662b25"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "a368cd11ad8d70c43cc2f50e57820c0e6896aefafcfd4cd4a2774564449e15ae"
    end
  end

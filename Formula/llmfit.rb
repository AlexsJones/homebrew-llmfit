class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "5f550028d6db4366dd176957d73e86e5570de72a4e71564448a3613837e78d45"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "cb36781c94c3d07dba29994c05514e54c6af9c17b306855a9f871cf73365b815"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "534d502649daa4f705dc430825b00ec22c0d345b0672d5bb218ff46ecb74b218"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "740a0f5fa7d5da6eadabadf4f85080b9706af02851ac5ea3b8cc722bc6057b33"
    end
  end

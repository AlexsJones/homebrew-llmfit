class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "65cb08dd4dcfd899c3edd2716454790e43390407238d05f8df370c096b80bcb6"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "aa3dc08f5e8fa4d76420504edbfc4cc4adbe5743784e05cbf7b2fcfcd0dd7f10"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "355d650aa88a96690869f115c8cb0ff178b05446eb6e54420fdb9b9e96b90fc1"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "d4c195a4998889d74d8bfa1c5d307ac7f492cf9dc56ae5ef4b3bc2d55eff15f9"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "6b39c92bb8e955a3d7aa201228fb4d84347085d8ba502ca07c05f942840850b1"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "aa9465eff6fd3661d26da1ca6848a5c9d0fd35a5aea2b1d2d42a83ba9a6f0a46"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "ba3d3ac52deda9e1685391b1b2a914f34461c3d646f4f9e25d4c6b7d69d445e3"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "aa50d65e09c7fcc2e090f2c6e25808ecb4e8775bd4059ae471c7a016772cee1e"
    end
  end

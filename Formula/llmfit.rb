class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "4a21c867b47e496ee7cb20035872c0fd49b3df85aa3d7edbf4b22030945a326f"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "7e2756fa54e2c54b31affb504b9f68862e2851f512d0fe9c4844d285eb5c8561"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "42616cebffd48a2fa137d27e5c8ffdbb106034dfe64296d17afaab7cd633f6ce"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "f167ccdfe34f8b8f63f9948409e5f273fcc545a23e1b7811856f6fcb48350b3d"
    end
  end

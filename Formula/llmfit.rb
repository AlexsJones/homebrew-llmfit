class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "243375d90a8edca1bd83ddcb1d2b5c8ce5f9649ec13c9ebe8f78d67eb6e27149"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "40be9ea73a91c1673d48cd53547f3c6c74ab4fd58564b15ea3a986ad060f0228"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "59223966e7b55b4d1b2e59a2c942a46c264e00974add824f7d12bfdaf43ed648"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "52235123a795dffd58417a1bffd04a37c38a9dbc586fb9727a6b3f860f34e7a2"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "e054f834d39c465b7bdb626f99987dba9b41a483281ea2efc2c75dfbd1c851fd"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "b7c88cd63373dcee5e6038198fb1585c0391207964f1864cd9b4682016af94be"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "fb0ee86c498a4958d7704bcbd0f3ff3cfccb5b1a5e193f33d438312d67f7ba59"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "29161880b25d151c38b0592e854794a9d01dcc78781ce1170fb30a643983e0ca"
    end
  end

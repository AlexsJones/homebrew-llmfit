class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "a8cb44a308ceb9e65a6d927e8a3eae2e1be24f4a7958eae76c8da028fea67db9"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "95bca625e03ac2ea3e5325b198aeaf5db02c4aaa8908434c0c28bb06458003b8"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "58ec0f1570096b7de404d046c32cf07c5fc680a984afb34c98d576bd164c3dc0"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "c8e7fab04927ff2f173c431d12f4abacdac273ad9d5838b1a986630f13405d78"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "f9beb75435d03ba3696b134281fccd101a5844e760ac2e712a4035c907c9ed91"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "1c298528d504fdbe1216ede0fea72902f6dc2818df1576ba8c7ef8d0543b7177"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "a4d845b5851813aab2bf1b1e8df76aab5b777bf603eff5f46cb4d12b48a432b9"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "a3b1c3cba264bb727f93793fa63264eb699cadafc9893456d1fef858bd226eff"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "a627baff86e27008e4669d0c04ff4e0bf1fc2a53239517c0167119f1ae73f6fa"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "3ff5bb652a6f339c27455c6b6b0c2955b0e5ad513bcf5e991bb4838711149e38"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "590589af6839e269d3be8ec8c7474754cb91d9644206af470ef3fc9356b92a68"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "bea82cb34e7e5238d7fc8093785bada64ccde5fd0b567b94fc855389057982f1"
    end
  end

class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "d771ed8e631924e0476f04aaee35455b1f3f4312e24914a033fdae6c061c2a9b"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "5198b7603e5c20c0f16b1ac2963d62909239d8ae0ef78d6c76af881f7875de74"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "4418280d2f47ac0baed21fbb288a2230ce615ddb0f46eb1ac6b32116a761dc86"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "22b57d34da210974c7dd45a31325e7dd6b6b9c0176ad8b7ceebe9c84bdec2977"
    end
  end

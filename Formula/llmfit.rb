class Llmfit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "fb8c5f9593dcff1c0aa6e1742adeb345613f206aae855a068bd4dd9aa4d9ec34"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "7a7ef685064eabd11b6a52f9445340a53011128b749694ed44af2a0512ad0cc9"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "258308214467ab8c661fc64f753515b327465f8293ee366c4334fc9664d44419"
    else
      url "https://github.com/AlexsJones/llmfit/releases/download/v#{version}/llmfit-v#{version}-x86_64-unknown-linux-musl.tar.gz"
      sha256 "d7da6cc711af542edbf8868f30854256d1cad545adacc63f504cfaf67e9836d6"
    end
  end
